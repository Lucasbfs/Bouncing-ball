...
// canvas.addEventListener("click", newBall)
// function newBall(event){
//     var ballsX;
//     var ballsY;
//     //ball starting position
//     ballsX = canvas.width / 2;   //the width of the canvas divided 2;
...
//     context.beginPath();
//     context.fillStyle = "yellow";
//     context.arc(ballsX[i], ballsY[i], bsize, 0, 2 * Math.PI);
...
//         // ballsX[i]; //new x ball location
//         // ballsY[i]; //new y ball location
//         // xVel[i]; //new x ball velocity
//         // yVel[i]; //new y ball velocity
//     }

//     //set interval tame (the game loop)
//     setInterval(update, 1000 / FPS); 

//     // var colors = ["yellow", "red", "green", "light", "maroon", "fuchsia", "navy",
//     // "turquoise", "springgreen", "gold"]
// }
...
//     //bounce the ball of each wall
//     if(ballsX - bsize / 2 < 0 && xVel < 0){
//         xVel = -xVel;
//     }
//     if(ballsX + bsize / 2 > canvas.width && xVel > 0){
//         xVel = -xVel;
//     }
//     if(ballsY - bsize / 2 < 0 && yVel < 0){
//         yVel = -yVel;
//     }
//     if(ballsY + bsize / 2 > canvas.height && yVel > 0){
//         yVel = -yVel;
//     }
